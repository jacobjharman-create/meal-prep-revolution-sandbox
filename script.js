...
const mealImages = {
  ...
  breakfast: "assets/images/black-container-builder/protein-eggs.png",
...
function currentBuild() {
  ...
  return {
    ...
    description,
    price,
    image: protein?.image || carb?.image || veg[0]?.image || mealImages.pack,
    selections: {
